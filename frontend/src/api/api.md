...
|»» toatal|integer|false|none||none|
|»» fieldList|[object]|false|none||none|
...
|scope|query|integer| 否 |none|
|ruleType|query|integer| 否 |none|
    ...
    "list": [
      {
        ...
        "ruleValue": "",
        "effect": 0,
        "//0代表全局不使用，1代表全局使用 \"createdAt\"": ""
      }
    ],
    "page": 1,
    "totel": 200,
    "pageSize:20. //分页处理": null
  },
  "timestamp": 0
}
```
...
|»»» ruleType|integer|false|none||none|
|»»» ruleValue|string|false|none||none|
|»»» status|integer|true|none|全局开关状态|0，关闭，1，打开|
...
|body|body|object| 否 |none|
|» taskId|body|integer| 是 |none|
|» ruleId|body|integer| 是 |none|
|» status|body|integer| 是 |0，关闭，1，打开|
...
删除拆句下所有断句以及断句所属的所有合成配置。

### 请求参数

|名称|位置|类型|必选|说明|
|---|---|---|---|---|
|originalSentenceId|query|integer| 是 |none|
...
|ruleType|string|true|none|规范类型|CHINESE_G2P：拼音<br />PHONETIC_SYMBOL：音标<br />CONTINUUM：连读<br />ALIAS：别名<br />SAY_AS：数字/英文的读法|
